...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '你好,这里是AmongUs足球围棋社，欢迎加入我们的AmongUs派对🎉 ⌈694185885⌋ ps:QQ群',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '再制祁珞', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ᗜ ˰ ​ᗜ​', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://md.igosoccer.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AmongUS,AU,BCL,BetterCrewLink,TheOtherUs,TOUE,近距离语音,饭堂时刻', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'kacptawrahs@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/381383048', // B站主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/igosoccer.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://npm.elemecdn.com/prism-themes/themes/prism-duotone-light.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-duotone-light.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-duotone-dark.css', // 深色模式主题
  ...
  MOUSE_FOLLOW_EFFECT_TYPE: 0, // 1-12
  MOUSE_FOLLOW_EFFECT_COLOR: '＃FFB6C1', // 鼠标点击特效颜色 #xxxxxx 或者 rgba(r,g,b,a)
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-9SYGYSDXKB', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  NOTION_PROPERTY_NAME: {
    ...
    author: process.env.NEXT_PUBLIC_NOTTON_PROPERTY_AUTHOR || 'author'
  },
